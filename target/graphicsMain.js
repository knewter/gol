...
var _user$project$World$initialCells = function (size) {
	return A2(
		_elm_lang$core$Array$repeat,
		size,
		A2(_elm_lang$core$Array$repeat, size, false));
};
var _user$project$World$isAliveAt = F2(
	function (_p0, model) {
		var _p1 = _p0;
		var _p2 = A2(_elm_lang$core$Array$get, _p1._0, model);
		if (_p2.ctor === 'Nothing') {
			return false;
		} else {
...
var _user$project$World$setLivingAt = F2(
	function (_p4, model) {
		var _p5 = _p4;
		var _p6 = _p5._0;
		var existingRow = A2(
			...
			A2(
				...
				false),
			A2(_elm_lang$core$Array$get, _p6, model));
		return A3(
			_elm_lang$core$Array$set,
			_p6,
			A3(_elm_lang$core$Array$set, _p5._1, true, existingRow),
			model);
	});
var _user$project$World$arrayIsAllFalse = function (array) {
	return _elm_lang$core$Basics$not(
		A3(
...
var _user$project$World$isEmpty = function (model) {
	return _user$project$World$arrayIsAllFalse(
		A2(
			_elm_lang$core$Array$map,
			function (_p7) {
				return _elm_lang$core$Basics$not(
					_user$project$World$arrayIsAllFalse(_p7));
			},
			model));
};
var _user$project$World$neighbors = F2(
	function (_p8, model) {
		var _p9 = _p8;
		var _p11 = _p9._1;
		var _p10 = _p9._0;
...
var _user$project$World$numberOfNeighbors = F2(
	function (position, model) {
		return _elm_lang$core$List$length(
			A2(
				_elm_lang$core$List$filter,
				function (p) {
					return A2(_user$project$World$isAliveAt, p, model);
				},
				A2(_user$project$World$neighbors, position, model)));
	});
var _user$project$World$cellAliveInNextGeneration = F2(
	function (position, model) {
		var _p12 = A2(_user$project$World$isAliveAt, position, model);
		if (_p12 === true) {
			return _elm_lang$core$Native_Utils.eq(
				2,
				A2(_user$project$World$numberOfNeighbors, position, model)) || _elm_lang$core$Native_Utils.eq(
				3,
				A2(_user$project$World$numberOfNeighbors, position, model));
		} else {
			return _elm_lang$core$Native_Utils.eq(
				3,
				A2(_user$project$World$numberOfNeighbors, position, model));
...
var _user$project$World$tick = function (model) {
	var tickRow = F2(
		function (x, row) {
			return A2(
				...
				F2(
					function (y, _p13) {
						return A2(
							_user$project$World$cellAliveInNextGeneration,
							{ctor: '_Tuple2', _0: x, _1: y},
							model);
					}),
				row);
		});
	return A2(_elm_lang$core$Array$indexedMap, tickRow, model);
};
var _user$project$World$init = _user$project$World$initialCells(100);

var _user$project$GraphicsMain$init = {
	ctor: '_Tuple2',
	_0: A2(
		_user$project$World$setLivingAt,
			...
			A2(
				...
				A2(
					...
					A2(
						...
						_user$project$World$init))))),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _user$project$GraphicsMain$viewCell = function (cell) {
	var color = function () {
		var _p0 = cell;
		if (_p0 === true) {
			return _elm_lang$core$Color$greyscale(1.0);
		} else {
			return _elm_lang$core$Color$greyscale(0.2);
		}
	}();
	return A2(
		_evancz$elm_graphics$Element$color,
		color,
		A3(_evancz$elm_graphics$Element$size, 10, 10, _evancz$elm_graphics$Element$empty));
};
var _user$project$GraphicsMain$viewRow = function (row) {
	return A2(
		_evancz$elm_graphics$Element$flow,
		_evancz$elm_graphics$Element$right,
		A2(
			_elm_lang$core$List$map,
			_user$project$GraphicsMain$viewCell,
			_elm_lang$core$Array$toList(row)));
};
var _user$project$GraphicsMain$view = function (model) {
	return _evancz$elm_graphics$Element$toHtml(
		A2(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$GraphicsMain$viewRow,
				_elm_lang$core$Array$toList(model))));
};
var _user$project$GraphicsMain$update = F2(
	function (msg, model) {
		var _p1 = msg;
		return {
			ctor: '_Tuple2',
			_0: _user$project$World$tick(model),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$GraphicsMain$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$GraphicsMain$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$millisecond * 30, _user$project$GraphicsMain$Tick);
};
var _user$project$GraphicsMain$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$GraphicsMain$init, update: _user$project$GraphicsMain$update, view: _user$project$GraphicsMain$view, subscriptions: _user$project$GraphicsMain$subscriptions})
};

var Elm = {};
Elm['GraphicsMain'] = Elm['GraphicsMain'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['GraphicsMain'], 'GraphicsMain', typeof _user$project$GraphicsMain$main === 'undefined' ? null : _user$project$GraphicsMain$main);
